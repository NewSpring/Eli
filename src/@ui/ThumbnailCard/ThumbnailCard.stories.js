  ...
  .add('With Description', () => (
    <View style={containerStyles}>
      <ThumbnailCard
        ...
        description="This is the story of a God, who made a flood and drowned the whole world. He gave up His son for everybody, and we absolutely love Him, all the time."
      />
    </View>
  ))
  .add('With images', () => (
