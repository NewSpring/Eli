...
class AppRouter extends PureComponent {
  ...
  largeScreenModals = [
    <Route
      ...
      path="/sections"
      key="sections-modal"
      component={asModal(tabs.Sections)}
    />,
    <Route
      path="/give/checkout"
      key="give-checkout"
    ...
    <Route
      ...
      key="forgot-password"
      component={asModal(ForgotPassword)}
    />,
  ...
  renderWebRedirects = () => (
    <View>
      ...
      <Route
        path="/watchandread"
        component={() => redirectToNewspring('watchandread')}
      />
      <Route
        path="/nextsteps"
        component={() => redirectToNewspring('nextsteps')}
      />
    </View>
  );
        ...
        {this.state.universalLinkLoading ? (
          ...
          <Player>
            <AppLayout>
              <CardStack
                location={
                  this.isModal || this.musicPlayerIsOpened
                    ? previousLocation
                    : this.props.location
                }
              >
                ...
                <Route
                  exact
                  path="/series/:seriesId/sermon/:id"
                  component={Sermon}
                />
                <Route
                  exact
                ...
                <Route
                  exact
                  path="/studies/:seriesId/entry/:id"
                  component={StudiesEntry}
                />
                ...
                <Route
                  exact
                  path="/groups/finder"
                  component={GroupFinderResults}
                />
                <Route exact path="/groups/:id" component={GroupSingle} />

                <Route
                  exact
                  path="/give/campaign/:id"
                  component={give.FundDetails}
                />
                ...
                <Route
                  exact
                  path="/give/restored-checkout"
                  component={give.RestoredCheckout}
                />
                <ProtectedRoute
                  exact
                ...
                <ProtectedRoute
                  ...
                  component={give.ScheduleDetails}
                />
